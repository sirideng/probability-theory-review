...
export default function MachineLearningLessonPage() {
  ...
  return <LongPageNavigation><div className="page-container pb-24 pt-8 sm:pt-14">
    <Link to="/machine-learning" className="liquid-control sticky top-20 z-10 inline-flex min-h-11 items-center gap-2 rounded-full border px-4 py-2 text-[14px] font-medium text-black/60 transition hover:text-blue lg:top-4"><ArrowLeft size={16} />返回机器学习地图</Link>
